                ...
                <div className='col-lg-6 d-flex align-items-center'>
                  <div>
                    ...
                    <p className='mt-3 banner-subtitle'>
                      Khám phá kho tàng đồ cũ chất lượng với giá hấp dẫn. Mua sắm thông minh, tiết kiệm và thân thiện
                      với môi trường.
                    </p>
                  ...
                  <div className='cardWithShadow'>
                    <div className='p-3'>
                      ...
                      <p className='mt-3 mb-0'>
                        Tôi rất hài lòng với trải nghiệm mua sắm tại ESOLD. Sản phẩm chất lượng, giá cả hợp lý. Giao
                        diện dễ sử dụng và quá trình đặt hàng rất thuận tiện.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className='col-lg-4 col-sm-6'>
                  <div className='cardWithShadow'>
                    <div className='p-3'>
                      ...
                      <p className='mt-3 mb-0'>
                        ESOLD là nơi tuyệt vời để tìm kiếm đồ cũ chất lượng. Tôi đã mua được nhiều món đồ ưng ý với giá
                        rẻ hơn rất nhiều so với mua mới. Dịch vụ khách hàng cũng rất tốt.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className='container'>
              ...
              <div className='row mt-5'>
                ...
                <div className='col-sm-4 col-lg-3 text-center mb-3'>
                  ...
                  <span className='mb-3 feature-detail d-block'>
                    Sử dụng trên máy tính, điện thoại và máy tính bảng.
                  </span>
                </div>
              </div>
            </div>
